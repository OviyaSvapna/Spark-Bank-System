...
body{
  ...
  align-items: center;
  background: linear-gradient(135deg, #6699ff, #ff99cc);
}
hr {
    ...
    <div class="screen">
      ...
      <div class="screen-body">
        <div class="screen-body-item left">
          <img class="img-fluid" src="img/p9.png" style="width:50%;  height:80%; align-items:center; display: block;margin-left: auto;margin-right: auto;">
        </div>
